...
<body style="background-color:#78a8ad;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Jhon Michael Mandao</h1>
            <p style="color:gray;"><b>Jose Rizal Memorial University Main Campus <br> Computer Engineering</b></p>
    </center>
